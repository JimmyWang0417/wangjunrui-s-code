 ...
 *    created:  2023.03.19 周日 09:01:42 (Asia/Shanghai)
 *    unicode:  UTF-8
 *    standard: c++23
 **/
#include <cstdio>
...
#else
    freopen("brezhnev.in", "r", stdin);
    freopen("brezhnev.out", "w", stdout);
#endif
    read(n, m);
    for (int i = 1; i < n; ++i)
    {
