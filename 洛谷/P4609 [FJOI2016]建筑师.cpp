/**
 *    unicode: UTF-8
 *    name:    P4609 [FJOI2016]建筑师
 *    author:  whitepaperdog (蒟蒻wjr)
 *    located: Changle District, Fuzhou City, Fujian Province, China
 *    created: 2023.01.30 周一 17:43:54 (Asia/Shanghai)
 **/
#include <cstdio>
#define ll long long
#define lll __int128
...
signed main()
{
    ...
    while (T--)
    {
        int n, A, B;
        read(n, A, B);
        write((S[n - 1][A + B - 2] * C[A + B - 2][A - 1]).data(), '\n');
    }
#ifdef FAST_OUT
    IO::OUTPUT::flush();
#endif
