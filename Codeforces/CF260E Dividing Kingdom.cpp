...
//	       query(root[linex2],root[n],1,tot,liney2+1,tot));
	return query(root[0],root[linex1],1,tot,1,Y[liney1])==a[1]
	       &&query(root[0],root[linex1],1,tot,Y[liney1]+1,Y[liney2])==a[2]
	       &&query(root[0],root[linex1],1,tot,Y[liney2]+1,tot)==a[3]

	       &&query(root[linex1],root[linex2],1,tot,1,Y[liney1])==a[4]
	       &&query(root[linex1],root[linex2],1,tot,Y[liney1]+1,Y[liney2])==a[5]
	       &&query(root[linex1],root[linex2],1,tot,Y[liney2]+1,tot)==a[6]

	       &&query(root[linex2],root[n],1,tot,1,Y[liney1])==a[7]
	       &&query(root[linex2],root[n],1,tot,Y[liney1]+1,Y[liney2])==a[8]
	       &&query(root[linex2],root[n],1,tot,Y[liney2]+1,tot)==a[9];
}
inline bool solve()
{
	int k;
